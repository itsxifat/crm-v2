...
const DEFAULTS = [
  'IT Services', 'Hardware Supplier', 'Software Supplier', 'Marketing Agency',
  'Printing & Media', 'Transport', 'Office Supplies', 'Maintenance', 'Legal', 'Other',
]
...
export async function GET() {
  try {
    ...
    const types = setting?.value ? JSON.parse(setting.value) : DEFAULTS
