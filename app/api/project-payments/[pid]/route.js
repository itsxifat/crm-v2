  ...
  try {
    ...
    if (action === 'confirm') {
      ...
      const tx = await new Transaction({
        ...
        currency:       'BDT',
        description:    `Payment received${payment.description ? ': ' + payment.description : ''} — ${project?.name ?? 'Project'}`,
        date:           payment.paymentDate,
        reference:      project?.projectCode ?? null,
        projectId:      payment.projectId?._id ?? payment.projectId,
        paymentMethod:  payment.paymentMethod,
        receiptUrl:     payment.receiptUrl ?? null,
        txnId:          txnId || undefined,   // auto-generated by pre-save hook if not provided
