...
const VENTURES    = [{ value: 'ENTECH', label: 'EnTech' }, { value: 'ENSTUDIO', label: 'EnStudio' }, { value: 'ENMARK', label: 'EnMark' }]
        ...
        <form onSubmit={handleSubmit} className="px-5 py-4 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <Select value={form.venture} onChange={v => set('venture', v ?? '')} options={VENTURES} placeholder="All Ventures" />
            </div>
            <div>
