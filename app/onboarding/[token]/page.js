          ...
          <div className="bg-gray-50 border border-gray-100 rounded-xl p-4 text-left">
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <p className="text-xl font-mono font-bold text-blue-700 tracking-widest">{creds.password}</p>
              </div>
            </div>
            <div className="mt-3 pt-3 border-t border-gray-100 flex items-start gap-2">
              <AlertCircle className="w-3.5 h-3.5 text-amber-500 shrink-0 mt-0.5" />
              <p className="text-xs text-amber-700">Save this password — it won't be shown again. Change it after your first login.</p>
            </div>
          </div>
        )}
