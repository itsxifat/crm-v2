...
async function getTransporter(purpose = 'general') {
  ...
  if (!account) {
    return {
      ...
      from: `"${process.env.SMTP_FROM_NAME || 'EN-Tech Agency'}" <${process.env.SMTP_FROM || process.env.SMTP_USER}>`,
    }
  }
  ...
  return {
    ...
    from: `"${account.fromName || 'EN-Tech Agency'}" <${account.user}>`,
  }
}
...
<body style="margin:0;padding:0;background:#f4f6fb;font-family:'Segoe UI',Arial,sans-serif;">
      ...
      <table width="560" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 2px 16px rgba(0,0,0,0.07);">
        <tr>
          <td style="background:linear-gradient(135deg,#2563eb,#4f46e5);padding:36px 40px;text-align:center;">
            <p style="margin:0;font-size:22px;font-weight:700;color:#ffffff;letter-spacing:-0.3px;">EN-Tech Agency</p>
        ...
        <tr>
          <td style="padding:36px 40px;">
            ...
            <p style="margin:0 0 16px;font-size:15px;color:#374151;line-height:1.6;">
              You have been invited to join <strong>EN-Tech Agency</strong> as a new team member.
        ...
        <tr>
          <td style="background:#f8fafc;border-top:1px solid #e5e7eb;padding:20px 40px;text-align:center;">
            <p style="margin:0;font-size:12px;color:#9ca3af;">
              This is an automated message from EN-Tech Agency CRM. Do not reply to this email.
            </p>
          </td>
        </tr>
      </table>
  ...
  await transporter.sendMail({ from, to, subject: 'Complete Your Onboarding — EN-Tech Agency', html })
}
...
<body style="margin:0;padding:0;background:#f4f6fb;font-family:'Segoe UI',Arial,sans-serif;">
      ...
      <table width="560" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 2px 16px rgba(0,0,0,0.07);">
        ...
        <tr>
          <td style="padding:36px 40px;">
            <p style="margin:0 0 16px;font-size:15px;color:#374151;">Hi${name ? ` <strong>${name}</strong>` : ''},</p>
            <p style="margin:0 0 16px;font-size:15px;color:#374151;line-height:1.6;">
              You have been added as a <strong>${typeLabel}</strong> on the <strong>EN-Tech Agency Panel</strong>.
  ...
  await transporter.sendMail({ from, to, subject: "You're invited to join EN-Tech Agency Panel", html })
}
...
<body style="margin:0;padding:0;background:#f4f6fb;font-family:'Segoe UI',Arial,sans-serif;">
      ...
      <table width="560" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 2px 16px rgba(0,0,0,0.07);">
        <tr>
          <td style="background:linear-gradient(135deg,#0f766e,#0891b2);padding:36px 40px;text-align:center;">
            <p style="margin:0;font-size:22px;font-weight:700;color:#ffffff;">EN-Tech Agency</p>
        ...
        <tr>
          <td style="padding:36px 40px;">
            ...
            <p style="margin:0 0 20px;font-size:15px;color:#374151;line-height:1.6;">
              Your client account has been created on the <strong>EN-Tech Agency</strong> panel.
        ...
        <tr>
          <td style="background:#f8fafc;border-top:1px solid #e5e7eb;padding:20px 40px;text-align:center;">
            <p style="margin:0;font-size:12px;color:#9ca3af;">This is an automated message from EN-Tech Agency CRM. Do not reply.</p>
          </td>
        </tr>
      </table>
    </td></tr>
  ...
  await transporter.sendMail({ from, to, subject: 'Your EN-Tech Agency Client Panel Access', html })
}
